...
if __name__ == "__main__":
    ...
    # ✨ thêm mới ở đây
    parser.add_argument("--input", type=str, help="Đường dẫn file PDF cần OCR")
    parser.add_argument("--output", type=str, help="Thư mục output sau OCR")
    parser.add_argument("--start", type=int, default=None, help="Trang bắt đầu (1-based)")
    parser.add_argument("--end", type=int, default=None, help="Trang kết thúc (1-based)")
